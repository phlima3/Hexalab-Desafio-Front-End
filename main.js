// PEGAR VALORES
 ...
 const gorjetaPorcentagemBotao = document.querySelector('input[name="valorGorjeta"]:checked')
  const gorjetaPorcentagemPersonal = document.getElementById("gorjetaPersonalizada") //Valor da porcentagem personalizada do pedido
